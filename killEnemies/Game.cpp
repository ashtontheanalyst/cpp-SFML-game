...
void Game::updateEnemies() {
    ...
    // Enemy movement and killing
    for (int i = 0; i < this->enemies.size(); i++) {
        this->enemies[i].move(0.f, 5.f); // moving them downward at a rate of 5 pixels/second

        bool deleted = false; // this value controls our delete conditional

        // KILL ENEMIES
        // Check if the enemies have been clicked, if the left mouse button returns true from isButtonPressed()...
        ...
        // If the top part of the enemy falls below the max y (bottom of the screen) delete it
        ...
        // One delete function for simplicity
        if (deleted) {
